...
'Click Dang Nhap tab'
WebUI.click(findTestObject('Object Repository/Tab_DangNhap'))
'Verify button “Đăng nhập” disabled'
WebUI.verifyElementNotClickable(findTestObject('Object Repository/btn_DangNhap'))
'Input so dien thoai'
WebUI.setText(findTestObject('Object Repository/txt_SoDT'), '1425345346')
'Input mat khau'
WebUI.setText(findTestObject('Object Repository/txt_Password'), 'ThisIsNotAPassword')
'Verify button “Đăng nhập” enabled'
WebUI.verifyElementClickable(findTestObject('Object Repository/btn_DangNhap'))
'Click Dang Nhap button'
WebUI.click(findTestObject('Object Repository/btn_DangNhap'))
'Verify the text is displayed'
WebUI.verifyElementText(findTestObject('Object Repository/lable_ValidateMessage'), 'Số điện thoại/Email hoặc Mật khẩu sai!')
